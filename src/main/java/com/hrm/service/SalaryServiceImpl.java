...
public class SalaryServiceImpl implements SalaryService {
    ...
    private SalaryDto calculateIndividualSalary(AttendanceDto attendance) {
        ...
        // 연장근무수당 계산 (시급 2만원 가정)
        BigDecimal overtimePay = new BigDecimal(attendance.getOvertimeHours())
    ...
    private void calculateDeductions(SalaryDto salary) {
        ...
        // 장기요양보험 (건강보험료의 12.81%)
        salary.setLongTermCareInsurance(
            salary.getHealthInsurance().multiply(new BigDecimal("0.1281"))
        );
